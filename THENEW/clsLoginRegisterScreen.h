...
#include "clsUser.h"
class clsLoginRegisterScreen :protected clsScreen1
{
private:
    ...
    static void PrintLoginRegisterRecordLine(clsUser::stLoginRegisterRecord LoginRegisterRecord)
    {
        ...
        cout << setw(8) << left << "" << "| " << setw(35) << left << LoginRegisterRecord.Date + "/" + LoginRegisterRecord.Hour;
        cout << "| " << setw(20) << left << LoginRegisterRecord.UserName;
        cout << "| " << setw(20) << left << LoginRegisterRecord.Password;
        cout << "| " << setw(10) << left << LoginRegisterRecord.PE;
    }
