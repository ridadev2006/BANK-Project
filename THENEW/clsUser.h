...
#include <vector>
#include <fstream>
#include "C:\Users\ZORO\Downloads\مكتبات\clsUtil.h"
#include "C:\Users\ZORO\Downloads\مكتبات\clsDate.h"
using namespace std;

class clsUser : public clsPerson1 
{
private:
    ...
    static clsUser _GetEmptyUserObject()
    {
     ...
     string _ProparoLodInRecord(string Seperator = "#//#")
    {

        string UserRecord = "";
        UserRecord += clsDate::DateToString(clsDate::GetSystemDate()) + Seperator;
        UserRecord += clsDate::GetCurrentHourString() + Seperator;
    ...
    static stLoginRegisterRecord _ConvertLineUsertoUserLogObject(string Line, string Seperator = "#//#")
     {
         vector<string> vUserData = clsString::Split(Line, Seperator);
         stLoginRegisterRecord M;
         M.Date = vUserData[0];
         M.Hour = vUserData[1];
         M.UserName = vUserData[2];
         M.Password = clsUtil::DecryptText(vUserData[3]);
         M.PE = stoi(vUserData[4]);
         return M;
     }
...
public:
    ...
    void RegistorLogIn()
    {
        string DateLine = _ProparoLodInRecord();
        fstream MyFile;
    ...
    static vector <stLoginRegisterRecord> GetLoginRegisterList()
    {
        ...
        if (MyFile.is_open())
        {
            ...
            while (getline(MyFile, Line))
            {
                ...
                stLoginRegisterRecord User = _ConvertLineUsertoUserLogObject(Line);
