...
#include "clsUdateRateCurrency.h"
#include "clsCalculatorCurrency.h"
class clsCurrencyScrren :protected clsScreen1
{
...
private:
    ...
    {
        clsListCurrency::ShowListCurrency();
    }
    ...
    {
        clsUdateRateCurrency::ShowUpdateCurrency();
    }

    static void _ShowCurrencyCalculatorScreen()
    {
        clsCalculatorCurrency::ShowCalculatorCurrency();
